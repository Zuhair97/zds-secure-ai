...
export default function ReputationNetworkPage() {
  ...
  const reputation = [

    {
      ...
      status:
        "Operational",
      details:
        "AI dynamically evaluating wallet trust and suspicious behavior patterns.",
    },

    {
      ...
      status:
        "Protected",
      details:
        "Phishing domains and malicious websites continuously monitored.",
    },

    {
      ...
      status:
        "Analyzing",
      details:
        "Global distributed threat intelligence and reputation scoring active.",
    },

    {
      feature:
        "Enterprise Trust Ranking",
      status:
        "Live",
      details:
        "AI-based trust evaluation infrastructure for digital services operational.",
    },
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div>
            ...
            <p className="text-zinc-300 text-lg">
              AI-powered cyber reputation intelligence and distributed trust infrastructure.
            </p>
